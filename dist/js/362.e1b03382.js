 ...
 * limitations under the License.
 */
function ml(t){t=Eh(t,Ih);const e=Eh(t.firestore,Rh);return dh(xh(e),t._key).then((n=>Il(e,t,n)))}class yl extends ul{constructor(t){super(),this.firestore=t}convertBytes(t){return new Mh(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Ih(this.firestore,null,e)}}function vl(t){t=Eh(t,Ch);const e=Eh(t.firestore,Rh),n=xh(e),s=new yl(e);return cl(t._query),fh(n,t._query).then((n=>new pl(e,s,t,n)))}function wl(t,e,n){t=Eh(t,Ih);const s=Eh(t.firestore,Rh),r=hl(t.converter,e,n);return _l(s,[zh(Hh(s),"setDoc",t._key,r,null!==t.converter,n).toMutation(t._key,fo.none())])}function El(t,e,n,...s){t=Eh(t,Ih);const r=Eh(t.firestore,Rh),i=Hh(r);let o;return o="string"==typeof(e=(0,a.m9)(e))||e instanceof Uh?Wh(i,"updateDoc",t._key,e,n,s):Qh(i,"updateDoc",t._key,e),_l(r,[o.toMutation(t._key,fo.exists(!0))])}function bl(t){return _l(Eh(t.firestore,Rh),[new Ao(t._key,fo.none())])}function Tl(t,...e){var n,s,r;t=(0,a.m9)(t);let i={includeMetadataChanges:!1},o=0;"object"!=typeof e[o]||Nh(e[o])||(i=e[o],o++);const c={includeMetadataChanges:i.includeMetadataChanges};if(Nh(e[o])){const t=e[o];e[o]=null===(n=t.next)||void 0===n?void 0:n.bind(t),e[o+1]=null===(s=t.error)||void 0===s?void 0:s.bind(t),e[o+2]=null===(r=t.complete)||void 0===r?void 0:r.bind(t)}let u,h,l;if(t instanceof Ih)h=Eh(t.firestore,Rh),l=Li(t._key.path),u={next:n=>{e[o]&&e[o](Il(h,t,n))},error:e[o+1],complete:e[o+2]};else{const n=Eh(t,Ch);h=Eh(n.firestore,Rh),l=n._query;const s=new yl(h);u={next:t=>{e[o]&&e[o](new pl(h,s,n,t))},error:e[o+1],complete:e[o+2]},cl(t._query)}return function(t,e,n,s){const r=new rh(s),i=new ku(e,r,n);return t.asyncQueue.enqueueAndForget((async()=>_u(await lh(t),i))),()=>{r.bc(),t.asyncQueue.enqueueAndForget((async()=>Iu(await lh(t),i)))}}(xh(h),l,c,u)}function _l(t,e){return function(t,e){const n=new js;return t.asyncQueue.enqueueAndForget((async()=>Fu(await hh(t),e,n))),n.promise}(xh(t),e)}function Il(t,e,n){const s=n.docs.get(e._key),r=new yl(t);return new dl(t,r,e._key,s,new ll(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
...
//# sourceMappingURL=362.e1b03382.js.map