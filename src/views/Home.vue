...
.intro_background ul>li, .intro_background ul>h4{
    padding-bottom: 8px;
}
.intro_background p{
    font-weight: bold;
...
.main_skill .card_area .card{
    width: 24%;
    border-radius: 10px;
    box-shadow: 0 0 8px rgba(128, 128, 128, 0.256);
    margin-bottom: 10px;
    padding: 10px;
}
.main_skill .card_area .card h3{
    width: 80%;
    margin: 10px auto;
    text-align: center;
    font-size: 1.25rem;
    font-weight: bold;
    border-bottom: 2px solid #1c595a;
    padding-bottom: 10px;
}
.main_skill .card_area .card li{
    width: 80%;
    margin: 6px auto;
    /* margin-left: 10%; */
    list-style: circle;
...
.timeline_area>div{
    position: relative;
    border-right: 8px solid #1c595a;
}
.timeline_area>div>.circle{
    width: 25px;
    height: 25px;
    position: absolute;
    top: calc(50% - 12.5px);
...
@media screen and (max-width: 1200px){
    ...
    .collection_area_left li {
        font-size: 0.85rem;
        list-style: circle;
    }
    .collection_area_right>.background{
        height: 50vw;
    }
}
</style>
